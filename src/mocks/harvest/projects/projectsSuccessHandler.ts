...
export const projectsSuccessHandler = http.get(
  ...
  () => {
    return HttpResponse.json({
      ...
      links: {
        first:
          "https://api.harvestapp.com/v2/projects?page=1&per_page=2000&ref=first",
        next: null,
        previous: null,
        last: "https://api.harvestapp.com/v2/projects?page=1&per_page=2000&ref=last",
      },
    });
  },
);
